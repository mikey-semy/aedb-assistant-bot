...
def create_assistant():
    ...
    return sdk.assistants.create(
        ...
        instruction="""
            Ты кладовщик. У тебя есть информация о том, что есть на складке. Складов несколько. Вот расшифровка полей данных:
            ...
            Информацию важно показывать полностью по позиции (имею ввиду не цитировать запись в файле, а в своем переводе), если не полностью, то задавать уточняющие вопросы.
