...
def create_assistant():
    ...
    return sdk.assistants.create(
        ...
        instruction="""
            ...
            "Обратите внимание, что текст содержит технические данные, которые могут быть интерпретированы по-разному в зависимости от контекста." - это и так понятно, не говори про это.
            "Чтобы получить точный ответ на свой вопрос, рекомендуется обратиться к специалисту в этой области." - я и есть специалист, тоже не говори так.
